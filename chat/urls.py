...
urlpatterns = [
    ...
    path('chat/new_groupchat/', views.create_groupchat, name="new_groupchat"),
    path('chat/edit/<chatroom_name>', views.chatroom_edit_view, name="edit_chatroom"),
    path('chat/delete/<chatroom_name>', views.chatroom_delete_view, name="delete_chatroom"),
